DELIMITER ;;
CREATE PROCEDURE @SCHEMA.`proc_linkage_step_4`()
BEGIN

    INSERT INTO @SCHEMA.linkage_log (id_object) VALUES ('proc_linkage_step_4');

    DROP TABLE IF EXISTS @SCHEMA.linkage_step_4;

    CREATE TABLE @SCHEMA.linkage_step_4 AS
        SELECT
    ...
    ALTER TABLE @SCHEMA.linkage_step_4 ADD PRIMARY KEY (PES_ID, CENS_ID);
