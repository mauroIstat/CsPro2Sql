DELIMITER ;;
CREATE PROCEDURE @SCHEMA.`proc_linkage_step_1`()
BEGIN

    DROP TABLE IF EXISTS @SCHEMA.linkage_step_1;

    CREATE TABLE @SCHEMA.linkage_step_1 AS
        SELECT
    ...
    ALTER TABLE @SCHEMA.linkage_step_1 ADD PRIMARY KEY (PES_ID, CENS_ID);
